...
var interestValidator = [
    validate({
        validator: 'isLength',
        arguments: [3, 25],
        message: 'Interest should be between {ARGS[0]} and {ARGS[1]} characters'
    }),
    validate({
        validator: 'isAlphanumeric',
        message: 'Interestinterest must contain letters and numbers only'
    })
];
...
var UserSchema = new Schema({
    ...
    interest: { type: String, required: true, validate: interestValidator }
});
